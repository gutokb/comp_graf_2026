...
flying_t = [0.0, 0.0, 50.0]
flying_r = [0.0, 0.0, 1.0, 0.0]
...
plane.set_model(0.0, 0, 0, 0, 0, 21.15, 0, 0.6, 0.6,0.6)
plane.set_transformations(['t','r'])
...
while not glfw.window_should_close(window):
    ...
    plane.set_parameters(0,flying_t)
    plane.set_parameters(1,flying_r)
    plane.draw()

    bomba.set_parameters(0,flying_t)
    bomba.set_parameters(1,flying_r)
    bomba.draw()
